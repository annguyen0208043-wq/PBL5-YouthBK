...
const TARGET_OPTIONS = [
  { value: 'faculty_students', label: 'Toàn bộ sinh viên khoa' },
...
export default function LienChiNotificationsPage() {
  ...
  return (
    <LienChiLayout
      currentPath="/lien-chi/notifications"
      title="Thông báo hệ thống"
      subtitle="Quản lý thông báo: gửi thông báo đến sinh viên khoa hoặc xem các thông báo nhận được từ Đoàn trường."
    >
      <div className="mb-6 flex gap-3">
        <button
          onClick={() => setActiveTab('send')}
          className={`rounded-2xl px-6 py-3 font-bold transition-all ${activeTab === 'send'
            ? 'bg-[#1747a6] text-white shadow-lg'
            : 'bg-white text-slate-500 hover:bg-[#f8fbff] hover:text-[#132b57]'
            }`}
        >
          Gửi thông báo
        </button>
        <button
          ...
          className={`rounded-2xl px-6 py-3 font-bold transition-all ${activeTab === 'inbox'
            ? 'bg-[#1747a6] text-white shadow-lg'
            : 'bg-white text-slate-500 hover:bg-[#f8fbff] hover:text-[#132b57]'
            }`}
        >
                        ...
                        {recipientResults.map((user) => {
                          ...
                          return (
                            <button
                              ...
                              className={`flex w-full items-center justify-between rounded-2xl border px-4 py-3 text-left transition-all ${selected
