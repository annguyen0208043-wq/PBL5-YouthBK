          ...
          <div className="relative z-10 flex h-full flex-col justify-between px-14 py-10">
            ...
            >
              ...
              <p className="mt-3 text-lg font-semibold text-[#2f80ed]">
                Số hóa hoạt động, kết nối sinh viên Bách Khoa Đà Nẵng
              </p>
            </motion.div>
          ...
          >
            <div className="rounded-[26px] border border-[#d9e7f4] bg-white px-6 py-8 shadow-[0_22px_45px_rgba(15,23,42,0.10)] sm:px-8">
              ...
              <div className="mt-6 text-center">
                <h2 className="text-4xl font-black uppercase tracking-tight text-[#132b57]">
                  Chào mừng trở lại!
                </h2>
              ...
              >
                ...
                >
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      className="h-4 w-4 rounded border-slate-300 text-[#1f5dcc] focus:ring-[#1f5dcc]"
                    />
